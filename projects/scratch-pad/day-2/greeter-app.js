...
function greeter(hour) {
    ...
    //begin our if else if statement 

    //if hour is les than 12 
    if (hour < 12) {
        //log good morning
        console.log('Good Morning!');
        //else if hour is less than 16
    } else if (hour < 17) {
        //log good afternoon
        ...
        //final case can be tied up in an else statement as we used the logic in descending order
